...
impl VomlError {
    ...
    pub fn unreachable() -> Self {
        Self { kind: Box::new(VomlErrorKind::Unreachable), level: DiagnosticLevel::None, file: None, range: None }
    }

    /// Constructor of [`NoteErrorKind::UndefinedVariable`]
    #[inline]
    pub fn undefined_variable(name: impl Into<String>) -> VomlError {
        let kind = VomlErrorKind::UndefinedVariable { name: name.into() };
